...
from yasearch.etc.format import maybe_json
from yasearch.processing.tokenizer import ITokenizer
from yasearch.processing.sample import SampleBasket
    ...
    def load(
        ...
        **kwargs,
        ...
        processor = cls.subclasses[config["klass"]].load(
            where, tokenizer=tokenizer, **kwargs
        )
        return processor
